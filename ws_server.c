...
"html,body{height:100%;background:#0d0d1a;color:#ccc;font-family:monospace;overflow:hidden}\n"
"html,body{height:100%;margin:0;padding:0}\n"
"body{display:flex;flex-direction:column;align-items:center;touch-action:none;height:100vh;overflow:hidden;background:#000}\n"
"#bar{display:flex;gap:6px;padding:6px;width:100%;background:#111120;flex-shrink:0;justify-content:center;align-items:center}\n"
...
"#dc{position:absolute;top:36px;left:36px;width:36px;height:36px;background:#111120;border-radius:3px}\n"
"#sys{display:flex;flex-direction:column;gap:8px}\n"
".sb{background:#1a1a30;color:#666;border:1px solid #333;border-radius:10px;padding:5px 14px;font:10px monospace;cursor:pointer;-webkit-user-select:none;user-select:none;touch-action:none;text-align:center}\n"
".sb:active,.sb.on{background:#3a3a70;color:#bbb}\n"
"#ab{position:relative;width:88px;height:72px}\n"
".ab{position:absolute;width:38px;height:38px;border-radius:50%;display:flex;align-items:center;justify-content:center;font:bold 14px monospace;color:#fff;cursor:pointer;-webkit-user-select:none;user-select:none;touch-action:none}\n"
".ab:active,.ab.on{filter:brightness(1.4)}\n"
"#abA{background:#9b2020;bottom:0;right:0}#abB{background:#6b2090;top:0;left:0}\n"
"#hint{font-size:11px;color:#333;text-align:center;padding:4px;flex-shrink:0}\n"
...
"<body>\n"
"<div id='bar'>\n"
"  <button class='tb' id='bsv'>Save State</button>\n"
"  <button class='tb' id='bld'>Load State</button>\n"
...
"  </div>\n"
"</div>\n"
"<div id='hint'>Arrows: D-Pad &nbsp; A: A button &nbsp; S: B button &nbsp; Enter: Start &nbsp; Shift: Select &nbsp; F5: Save State &nbsp; F8: Load State</div>\n"
"<script>\n"
"(function(){\n"
"'use strict';\n"
